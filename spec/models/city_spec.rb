describe City do
  ...
  describe 'instance methods' do
    it 'knows about all the available listings given a date range' do
      expect(City.first.available_listings('2014-05-01', '2014-05-05')).to include(@listing2,@listing3) 
      expect(City.first.available_listings('2014-05-01', '2014-05-05')).to_not include(@listing1)
    end 
  end
